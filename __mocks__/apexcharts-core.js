// Mock for apexcharts/core module (tree-shaking variant)
// Same API as apexcharts/client but imported from apexcharts/core
...
ApexCharts.renderToHTML = jest.fn().mockResolvedValue('<div class="apexcharts-canvas">Chart HTML</div>')
